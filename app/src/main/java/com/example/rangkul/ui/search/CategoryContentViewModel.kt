...
import com.example.rangkul.data.repository.CategoryRepository
import com.example.rangkul.utils.UiState
import dagger.hilt.android.lifecycle.HiltViewModel
import javax.inject.Inject

@HiltViewModel
class CategoryContentViewModel @Inject constructor(private val repository: CategoryRepository): ViewModel() {
